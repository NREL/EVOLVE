...
export function CreateScenario(props: any) {
    ...
    const [formData, setFormData, errors, setErrors,
        ...
        fillData, setFillData, dateRange, setDateRange] = UseBasicForm()

    // Get solar form data
    const [solarFormDataArray, setSolarFormDataArray,
        solarErrorsArray, setSolarErrorsArray, handleAddSolar,
        handleSolarDelete, selectedIrrProfile, setSelectedIrrProfile] = UseSolarForm()
    ...
    const handleFormSubmit = (e: any) => {
        ...
        let fullFormData = {
            'basic': {
                ...formData, 'loadProfile': selectedProfile.id
            },
